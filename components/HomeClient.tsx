        ...
        <div className="max-w-7xl w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="relative w-full max-w-md mx-auto lg:max-w-none rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 p-[3px] shadow-[0_0_20px_rgba(59,130,246,0.4),0_0_32px_rgba(147,51,234,0.35)]">
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-600 blur-[6px] opacity-70" />
